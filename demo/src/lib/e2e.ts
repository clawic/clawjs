    ...
    adapters: [
      {
        ...
        recommended: true,
        capabilities: [
          { key: "chat", supported: true, status: "ready", strategy: "fixture" },
          { key: "memory", supported: true, status: "ready", strategy: "fixture" },
          { key: "images", supported: true, status: "ready", strategy: "fixture" },
        ],
        providers: [
