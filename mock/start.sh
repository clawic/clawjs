...
export CLAWLEN_OPENCLAW_WORKSPACE_DIR="$MOCK_WORKSPACE_DIR"
export CLAWLEN_OPENCLAW_AGENT_DIR="$MOCK_AGENT_DIR"
export CLAWLEN_OPENCLAW_SESSIONS_DIR="$MOCK_SESSIONS_DIR"
